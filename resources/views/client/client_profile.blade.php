                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="city_id" class="form-select">
                                            ...
                                            @foreach ($city as $cit)
                                            <option value="{{ $cit->id }}" {{ $cit->id == $profileData->city_id ? 'selected' : '' }}>{{ $cit->city_name }}</option> @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">Restaurant Info</label>
                                        <textarea name="shop_info" id="basicpill-address-input" class="form-control"
                                            rows="2"
