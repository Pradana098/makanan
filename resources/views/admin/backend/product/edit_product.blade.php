            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" action="{{ route('admin.product.update') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="best_seller" type="checkbox" id="formCheck2"
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="most_populer" type="checkbox" id="formCheck2"
