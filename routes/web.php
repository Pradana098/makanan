...
Route::get('/client/forget_password', [ClientController::class, 'ClientForgetPassword'])->name('client.client_forget_password');
...
Route::middleware('admin')->group(function () {
    ...
    Route::controller(ManageController::class)->group(function () {
        ...
        Route::post('/admin/update/product', 'AdiminUpdateProduct')->name('admin.product.update');
...
// Route::get('/client/order/{orderId}', [OrderController::class, 'details'])
